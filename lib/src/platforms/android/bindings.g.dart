...
class FileSaver extends jni$_.JObject {
  ...
  static final _id_getImageSaver = _class.instanceMethodId(
    r'getImageSaver',
    r'()Lcom/vanvixi/file_saver_ffi/ImageSaver;',
  );

  static final _getImageSaver =
      jni$_.ProtectedJniExtensions.lookup<
            jni$_.NativeFunction<
              jni$_.JniResult Function(
                jni$_.Pointer<jni$_.Void>,
  ...
  /// from: `public final com.vanvixi.file_saver_ffi.ImageSaver getImageSaver()`
  /// The returned object must be released after use, by calling the [release] method.
  jni$_.JObject getImageSaver() {
    return _getImageSaver(
      reference.pointer,
      _id_getImageSaver as jni$_.JMethodIDPtr,
    ).object<jni$_.JObject>(const jni$_.$JObject$Type$());
  }

  static final _id_getVideoSaver = _class.instanceMethodId(
    r'getVideoSaver',
    r'()Lcom/vanvixi/file_saver_ffi/VideoSaver;',
  );

  static final _getVideoSaver =
      jni$_.ProtectedJniExtensions.lookup<
            jni$_.NativeFunction<
              jni$_.JniResult Function(
                jni$_.Pointer<jni$_.Void>,
  ...
  /// from: `public final com.vanvixi.file_saver_ffi.VideoSaver getVideoSaver()`
  /// The returned object must be released after use, by calling the [release] method.
  jni$_.JObject getVideoSaver() {
    return _getVideoSaver(
      reference.pointer,
      _id_getVideoSaver as jni$_.JMethodIDPtr,
    ).object<jni$_.JObject>(const jni$_.$JObject$Type$());
  }

  static final _id_getAudioSaver = _class.instanceMethodId(
    r'getAudioSaver',
    r'()Lcom/vanvixi/file_saver_ffi/AudioSaver;',
  );

  static final _getAudioSaver =
      jni$_.ProtectedJniExtensions.lookup<
            jni$_.NativeFunction<
              jni$_.JniResult Function(
                jni$_.Pointer<jni$_.Void>,
  ...
  /// from: `public final com.vanvixi.file_saver_ffi.AudioSaver getAudioSaver()`
  /// The returned object must be released after use, by calling the [release] method.
  jni$_.JObject getAudioSaver() {
    return _getAudioSaver(
      reference.pointer,
      _id_getAudioSaver as jni$_.JMethodIDPtr,
    ).object<jni$_.JObject>(const jni$_.$JObject$Type$());
  }

  static final _id_getCustomFileSaver = _class.instanceMethodId(
    r'getCustomFileSaver',
    r'()Lcom/vanvixi/file_saver_ffi/CustomFileSaver;',
  );

  static final _getCustomFileSaver =
      jni$_.ProtectedJniExtensions.lookup<
            jni$_.NativeFunction<
              jni$_.JniResult Function(
                jni$_.Pointer<jni$_.Void>,
  ...
  /// from: `public final com.vanvixi.file_saver_ffi.CustomFileSaver getCustomFileSaver()`
  /// The returned object must be released after use, by calling the [release] method.
  jni$_.JObject getCustomFileSaver() {
    return _getCustomFileSaver(
      reference.pointer,
      _id_getCustomFileSaver as jni$_.JMethodIDPtr,
    ).object<jni$_.JObject>(const jni$_.$JObject$Type$());
  }
